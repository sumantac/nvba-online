...
@Component({
  selector: 'app-foodtickets',
  templateUrl: './foodtickets.component.html',
  styleUrls: ['./foodtickets.component.scss']
})
export class FoodticketsComponent implements OnInit, OnChanges, AfterViewChecked {
 ...
 //   this.cs.addToCart(this.checkObject);
    this.router.navigate(['/foodcheckout']);
