...
export class AlldetailsComponent implements OnInit {
  ...
  columnDefs = [
    ...
    { field: 'MM2022YY', headerName:'Membership', sortable: true },

    { field: 'DP2022EBALL01NON', headerName:'EBALL01NON', sortable: true },
    { field: 'DP2022EBALL02VEG', headerName:'EBALL02VEG', sortable: true },
    { field: 'DP2022EBALL03NON', headerName:'EBALL03NON', sortable: true },
    { field: 'DP2022EBALL04VEG', headerName:'EBALL04VEG', sortable: true },
    { field: 'DP2022EBALL05KID', headerName:'EBALL05KID', sortable: true },
    { field: 'DP2022EBALL06NON', headerName:'EBALL06NON', sortable: true },
    { field: 'DP2022EBALL07VEG', headerName:'EBALL07VEG', sortable: true },

    { field: 'DP2022EBFRI01NON', headerName:'EBFRI01NON', sortable: true },
    { field: 'DP2022EBFRI02VEG', headerName:'EBFRI02VEG', sortable: true },
    { field: 'DP2022EBFRI03NON', headerName:'EBFRI03NON', sortable: true },
    { field: 'DP2022EBFRI04VEG', headerName:'EBFRI04VEG', sortable: true },
    { field: 'DP2022EBFRI05KID', headerName:'EBFRI05KID', sortable: true },
    { field: 'DP2022EBFRI06NON', headerName:'EBFRI06NON', sortable: true },
    { field: 'DP2022EBFRI07VEG', headerName:'EBFRI07VEG', sortable: true },

    { field: 'DP2022EBSAT01NON', headerName:'EBSAT01NON', sortable: true },
    { field: 'DP2022EBSAT02VEG', headerName:'EBSAT02VEG', sortable: true },
    { field: 'DP2022EBSAT03NON', headerName:'EBSAT03NON', sortable: true },
    { field: 'DP2022EBSAT04VEG', headerName:'EBSAT04VEG', sortable: true },
    { field: 'DP2022EBSAT05KID', headerName:'EBSAT05KID', sortable: true },
    { field: 'DP2022EBSAT06NON', headerName:'EBSAT06NON', sortable: true },
    { field: 'DP2022EBSAT07VEG', headerName:'EBSAT07VEG', sortable: true },

    { field: 'DP2022EBSUN01NON', headerName:'EBSUN01NON', sortable: true },
    { field: 'DP2022EBSUN02VEG', headerName:'EBSUN02VEG', sortable: true },
    { field: 'DP2022EBSUN03NON', headerName:'EBSUN03NON', sortable: true },
    { field: 'DP2022EBSUN04VEG', headerName:'EBSUN04VEG', sortable: true },
    { field: 'DP2022EBSUN05KID', headerName:'EBSUN05KID', sortable: true },
    { field: 'DP2022EBSUN06NON', headerName:'EBSUN06NON', sortable: true },
    { field: 'DP2022EBSUN07VEG', headerName:'EBSUN07VEG', sortable: true },
      ...
      //     console.log(element.sku);
          [...element].forEach(e => {
                ...
                if(e.sku.includes("DP2022EBALL01NON")){
                    ...
                    // const x = { DP2022EBALL01NON: this.DP2022EBALL01NON  }
                    // this.memberList = { ...this.user, ...x } ;
                }
