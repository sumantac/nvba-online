...
@Component({
  selector: 'app-durgapujatickets2023',
  templateUrl: './durgapujatickets2023.component.html',
  styleUrls: ['./durgapujatickets2023.component.scss']
})
export class Durgapujatickets2023Component implements OnInit, OnChanges, AfterViewChecked {
  ...
  private _jsonURLcart = '/assets/data/tickets/durgapuja-2023-earlybird.json';
